...
export class AnimeService {
  ...
  private animeDetails: AnimeDetails[] = [
    ...
    new AnimeDetails(5, 'ジョジョの奇妙な冒険', 'Jojo no kimyouna bouken', 'https://cdn.myanimelist.net/images/anime/3/40409.jpg', '', new Date('2006-05-05T00:00:00Z'), new Date('2006-12-05T00:00:00Z'), 26, Status.CurrentlyAiring, Demographic.Seinen),
    ...
    new AnimeDetails(8, 'うみねこのなく頃に', 'Umineko no naku koro ni', 'https://cdn.myanimelist.net/images/anime/10/17709.jpg', '', new Date('2006-05-05T00:00:00Z'), new Date('2006-12-05T00:00:00Z'), 26, Status.CurrentlyAiring, Demographic.Seinen),
    new AnimeDetails(9, '化物語', 'Bakemonogatari', 'https://cdn.myanimelist.net/images/anime/11/75274.jpg', '', new Date('2006-05-05T00:00:00Z'), new Date('2006-12-05T00:00:00Z'), 26, Status.CurrentlyAiring, Demographic.Seinen),
    new AnimeDetails(10, '鋼の錬金術師', 'Fullmetal Alchemist: Brotherhood', 'https://cdn.myanimelist.net/images/anime/1223/96541.jpg', '', new Date('2006-05-05T00:00:00Z'), new Date('2006-12-05T00:00:00Z'), 26, Status.CurrentlyAiring, Demographic.Seinen)
  ]
  constructor() { }
}
